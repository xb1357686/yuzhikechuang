...
class Product extends React.Component {
    ...
    this.state = {
      ...
      Columns: [
        ...
        },
        {
          ...
          render: (text, record) => (
            <div>
              <Switch checkedChildren="公" unCheckedChildren="私" checked={text == 0} onChange={(e) => { this.checkWorkPrivate(e, record) }} />
            </div>
          )
        },
        {
          ...
          render: (text, record) => {
            return (
              <div>
                ...
                <Button type="primary" onClick={() => this.gotoProduct(record)} >  详情页 </Button>
              </div>
            )
          },
        }
  ...
  // 跳转至工具详情页
  gotoProduct = (record) => {
    this.props.history.push({ pathname: `/community/applyStl/${record.workId} ` })
  }
    ...
    return (
      <ConfigProvider locale={zhCN}>
        <Form layout="inline">
          ...
          <div style={{ marginBottom: '20px' }}>
            <Button style={{ margin: '2px 10px' }} type="primary" onClick={this.addTeacher} >  +添加作品 </Button>
          ...
          >
            ...
            <Form.Item {...ItemLayout} label="作品名称">
              {getFieldDecorator("workTitle", {
                ...
                <Input type="text" maxLength={50} placeholder="请输入作品名称" style={{ width: '300px' }} />
              )}
            </Form.Item>
            <Form.Item {...ItemLayout} label="上传作品">
              {getFieldDecorator('videoUrl', {
                ...
                <Upload {...uploadProps1} listType={null} showUploadList={{ showPreviewIcon: false, showDownloadIcon: false, showRemoveIcon: true }} onChange={(file) => { this.handleChange(file, 'imgOrMp4') }}>
                  ...
                  <span style={{ marginLeft: '10px', color: '#b0b0b0' }}>支持格式：STL （文件）</span>
                </Upload>
              )}
            </Form.Item>
